...
public class Batalha extends JFrame {
	...
	private JList<String> hud1, hud2;
	...
	public void initComponents() {
		...
		panel = new JPanel() {
	 	   ...
	 	   hud1 = new JList<String>(stringItens1);
	 	    hud1.setBounds(10, 263, 112, 72);
	 	    contentPane.add(hud1);
	 	    stringItens1.addElement(itensClass.getName(0));
	 	    stringItens1.addElement(itensClass.getName(5));
	 	    stringItens1.addElement(itensClass.getName(14));
	 	    
	 	    hud2 = new JList<String>(stringItens2);
	 	    hud2.setBounds(376, 263, 112, 72);
	 	    contentPane.add(hud2);
	 	   stringItens2.addElement(itensClass.getName(3));
	 	    stringItens2.addElement(itensClass.getName(8));
	 	    stringItens2.addElement(itensClass.getName(12));
	...
	public void batalhaTurnos(Jogador_Model J1, Jogador_Model J2, int round) {
		...
		int ataq1 = J1.getAttk(),defe1 = J1.getDef(),vida1S = J1.getVida(),mana1S = J1.getMana(),regenVida1 = J1.getRegVida();

	    int ataq2 = J2.getAttk(),defe2 = J2.getDef(),vida2S = J2.getVida(),mana2S = J2.getMana(),regenVida2 = J2.getRegVida();
	   ...
	   int resto;
	    ...
	    // Atualizações da Vida/Def de ambos Jogadores + Atualização das barras de vida
	    ...
	    vidaBar1.setMaximum(J1.getVidaMax());
	    vidaBar2.setMaximum(J2.getVidaMax());
	    vidaBar1.setValue(vida1S);
	    vidaBar2.setValue(vida2S);
